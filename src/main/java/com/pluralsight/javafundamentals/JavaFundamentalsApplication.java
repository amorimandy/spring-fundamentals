...
import com.pluralsight.javafundamentals.repository.ApplicationRepository;
...
public class JavaFundamentalsApplication {
	...
	private static final Logger log = LoggerFactory.getLogger(JavaFundamentalsApplication.class);
